...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BzlzOw2W.js
var router_BzlzOw2W_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-CTQXQEnN.css";
var APP_NAME = "晶切";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "玻璃牛排 ASMR：切开一块琥珀玻璃肋眼，带切割声。"
			},
			{
				name: "theme-color",
				content: "#070708"
...
var $$splitComponentImporter = () => import("./routes-CJdiHbIq.mjs");
...
//#endregion
export { getRouter, router_BzlzOw2W_exports as t };
